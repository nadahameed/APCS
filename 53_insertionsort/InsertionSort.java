 ...
 *
 * DISCO
 * insertion sort, bubble sort, and selection sort all take the same number of passes
 * insertion sort doesn't finish each pass though, so it may be more efficient
 *
 * QCC
